...
var _dest = {
	root	: '../PokerGame.MVC/Content/',
    index   : '../PokerGame.MVC/Views/Home/',
    styles  : '../PokerGame.MVC/Content/css/',
    images  : '../PokerGame.MVC/Content/img/',
    fonts 	: '../PokerGame.MVC/Content/css/fonts/',
    scripts : '../PokerGame.MVC/Content/js/'
};
